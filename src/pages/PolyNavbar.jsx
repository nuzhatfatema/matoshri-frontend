  ...
  return (
    <nav className="poly-nav">
      <ul className="poly-nav-list">
        ...
        <li className="active" onClick={handleHomeClick}>
          Home
        </li>
          ...
          {openMenu === "facilities" && (
            <ul className="dropdown-menu">
              <li
                onClick={() =>
                  navigate(
                    "/vishwabharati-polytechnic-institute/facilities/classrooms"
                  )
                }
              >
                Classrooms
              ...
              <li
                onClick={() =>
                  navigate(
                    "/vishwabharati-polytechnic-institute/facilities/girls-boys-hostel"
                  )
                }
              >
