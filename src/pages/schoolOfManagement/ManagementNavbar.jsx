...
function ManagementNavbar() {
  ...
  const handleHomeClick = () => {
    navigate("/school-of-management/home");
  };
    ...
    <nav className="poly-nav">
      <ul className="poly-nav-list">
       ...
       <li onClick={() => navigate("/")}>Home</li>
          ...
          {openMenu === "dept" && (
            <ul className="dropdown-menu">
              <li
                onClick={() =>
                  navigate(
                    "/school-of-management/departments/mba/profile"
                  )
                }
              >
                MBA Program
        ...
        {/* ADMISSION */}
        <li   onMouseEnter={() => setOpenMenu("addm")}
          onMouseLeave={() => setOpenMenu(null)}>
            Admission
             {openMenu === "addm" && (
            <ul className="dropdown-menu">
         ...
         <li
                onClick={() =>
                  navigate(
                    "/school-of-management/admission/fee-structure"
                  )
                }
              >
        Fee Structure </li>
...
>
  Admission process 2025-26 </li>
         <li
                onClick={() =>
                  navigate(
                    "/school-of-management/admission/undertaking"
                  )
                }
              >
         Undertaking </li>
          <li onClick={() =>
                  navigate(
                    "/school-of-management/admission/Information Brochure 2025-26"
                  )
                }
              
          >Information Brochure 2025-2026 </li>
...
>
  ...
  {openMenu === "facilities" && (
    <ul className="dropdown-menu">
      <li
        onClick={() =>
          navigate("/school-of-management/facilities/classrooms")
        }
      >
        Classrooms
      </li>
